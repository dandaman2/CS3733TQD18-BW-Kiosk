...
public class Astar extends Algorithm{
    ...
    */
    public ArrayList<Node> findPath(Node n1, Node n2, ArrayList<String> noTypes) {
        ...
        System.out.println("Indexes and ID-s of start and finish");
        System.out.println(start + " " + finish + " ===================");
        System.out.println(n1.getNodeID() + " " + n2.getNodeID() + " ===================");
...
//            System.out.println(now + " <========== " + neighbours[now].size());

            //    Double total_length = TOP.getTot_Dist();
                    ...
                    pq.add(
                            new MyPair(
                                    distance.get(to)                            // real distance
                                            +
                                            n2.calcDistance(NodesList.get(now)), // heuristic distance
                                    distance.get(to),
                                    to
                            )
                    );
        ...
        System.out.println("AI KACI        = " + distance.get(n2.getIndex()));
